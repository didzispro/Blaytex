...
public class PlayerController : MonoBehaviour
{
    ...
    void Movement()
    {
        ...
        if (Input.GetKey(KeyCode.A) && Input.GetKeyDown(KeyCode.S) && gameManager.canAttack && isRolling1 && gameManager.canStart)
        {
            AnimationStartsLeft();
        }

        if (Input.GetKey(KeyCode.D) && Input.GetKeyDown(KeyCode.S) && gameManager.canAttack && isRolling1 && gameManager.canStart)
        {
    ...
    void AttackStuff()
    {
        if (Input.GetKeyDown(KeyCode.F) && gameManager.canAttack)
        {
            Attack();
        }

        if (Input.GetKeyDown(KeyCode.G) && gameManager.canAttack)
        {
            AttackHorizontal();
        }
    }
    ...
    void RollMovement()
    {
        if (Input.GetKey(KeyCode.LeftArrow) && Input.GetKeyDown(KeyCode.DownArrow) && gameManager.canAttack && isRolling1 && gameManager.canStart)
        {
            AnimationStartsLeft();
        }

        if (Input.GetKey(KeyCode.RightArrow) && Input.GetKeyDown(KeyCode.DownArrow) && gameManager.canAttack && isRolling1 && gameManager.canStart)
        {
            AnimationStartsRight();
        }
    }
    ...
    void Attack()
    {
        ...
        foreach (Collider2D enemy in hitenemy)
        {
            ...
            enemy.GetComponent<Enemy>().Knockback(dir);
        }
    ...
    void Die()
    {
        ...
        gameManager.OnRoundEnd(GameManager.RoundResult.Enemy);
