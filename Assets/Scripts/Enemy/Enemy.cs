...
public class Enemy : MonoBehaviour
{
    ...
    void AttackStuff()
    {
        ...
        {
            float attackVertical = 60f;
            float attackHorizontal = 50f;
    ...
    void Rolling()
    {
        if (distance > 1.5f && !canAttack && !isrolling && gameManager.canStart && playerController.isAttack)
        {
            float rollLeft = 30f;
    ...
    void JumpChance()
    {
        ...
        if (jumpTimer <= 0f && canJump && isGround && playerController.isAttack)
        {
            float backChance = 35f;
    ...
    void Die()
    {
        ...
        gameManager.OnRoundEnd(GameManager.RoundResult.Player);
    }
    ...
    IEnumerator AttackWindup()
    {
        ...
        foreach (Collider2D player in hitplayer)
        {
            ...
            player.GetComponent<PlayerController>().Knockback(dir);
        }
